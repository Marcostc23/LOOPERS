<?php
session_start();
require "conexion.php"; // Se mantiene igual porque están en la misma carpeta
...
<head>
    ...
    <link rel="stylesheet" href="../frontendcss/styles.css">
    ...
    <div class="row g-5">
        ...
        <div class="col-lg-4">
            <div class="summary-box">
                ...
                <a href="finalizar_compra.php" class="btn btn-checkout">FINALIZAR COMPRA</a>
                <a href="catalogo.php" class="btn btn-link w-100 text-secondary text-decoration-none mt-2">Seguir comprando</a>
